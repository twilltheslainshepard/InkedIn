...
class UserAccountSetupWidget extends StatefulWidget {
  const UserAccountSetupWidget({super.key});

  @override
  State<UserAccountSetupWidget> createState() => _UserAccountSetupWidgetState();
}
                            ...
                            child: Column(
                              ...
                              children: [
                                Align(
                                  alignment: const AlignmentDirectional(0.0, 0.0),
                                  child: Text(
                                    'Let’s register an account as a \nuser!',
