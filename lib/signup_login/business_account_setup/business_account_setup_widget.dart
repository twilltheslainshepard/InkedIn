...
class BusinessAccountSetupWidget extends StatefulWidget {
  const BusinessAccountSetupWidget({super.key});

  @override
  State<BusinessAccountSetupWidget> createState() =>
      _BusinessAccountSetupWidgetState();
}

class _BusinessAccountSetupWidgetState
    extends State<BusinessAccountSetupWidget> {
  late BusinessAccountSetupModel _model;
                            ...
                            child: Column(
                              ...
                              children: [
                                Align(
                                  alignment: const AlignmentDirectional(0.0, 0.0),
                                  child: Text(
                                    'Let’s register an account as a business!',
                          ...
                          child: Row(
                            ...
                            children: [
                              Align(
                                ...
                                child: Text(
                                  'Upload an Image of your tattoo license:',
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                                        fontFamily: 'Inter',
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        ...
                        await currentUserReference!
                          ...
                          tattooShopName: _model.textController2.text,
                          tattooShopAddress: _model.textController3.text,
