  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<UsersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRecord> savedpostsUsersRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final savedpostsUsersRecord = savedpostsUsersRecordList.isNotEmpty
            ? savedpostsUsersRecordList.first
            : null;
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Expanded(
                              child: Builder(
                                builder: (context) {
                                  final savedPosts = savedpostsUsersRecord
                                          ?.savedPosts
                                          .toList() ??
                                      [];
                                  ...
                                  return GridView.builder(
                                    ...
                                    itemBuilder: (context, savedPostsIndex) {
